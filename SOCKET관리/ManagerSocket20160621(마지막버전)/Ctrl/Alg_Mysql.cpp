...
CAlg_Mysql::CAlg_Mysql()
{
	...
	// Mysql DB 정의
	// Mysql DB 정의
	m_nManagerTableCnt			= 8;
	m_strManagerTableName[0]	= _T("NO");
	m_strManagerTableName[1]	= _T("DATE");
	m_strManagerTableName[2]	= _T("SERIAL");
	m_strManagerTableName[3]	= _T("HIFIX");
	m_strManagerTableName[4]	= _T("COUNT");
	m_strManagerTableName[5]	= _T("SLOT");
	m_strManagerTableName[6]	= _T("TYPE");
	m_strManagerTableName[7]	= _T("EQP");

	m_nManagerTableNum[0]		= 5;
	m_nManagerTableNum[1]		= 30;
	m_nManagerTableNum[2]		= 20;
	m_nManagerTableNum[3]		= 5;
	m_nManagerTableNum[4]		= 10;
	m_nManagerTableNum[5]		= 5;
	m_nManagerTableNum[6]		= 5;
	m_nManagerTableNum[7]		= 20;

	m_nManagerTableType[0]		= ID_TYPE;
	m_nManagerTableType[1]		= DATEAUTO_TYPE;
	m_nManagerTableType[2]		= TEXT_TYPE;
	m_nManagerTableType[3]		= INT_TYPE;
	m_nManagerTableType[4]		= INT_TYPE;
	m_nManagerTableType[5]		= INT_TYPE;
	m_nManagerTableType[6]		= TEXT_TYPE;
	m_nManagerTableType[7]		= TEXT_TYPE;
