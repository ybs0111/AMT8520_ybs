...
void CScreen_Motor_With_IO::OnInitIO()
{
	...
	else
	{
		...
		if(st_handler.mn_mirror_type == CTL_YES)
		{
			GridMerge( iGrid, 3, 1, 2, 1 );			GridData( iGrid, 3, 1, "가이드 3");			GridData( iGrid, 3, 2, "F" );	GridData( iGrid, 4, 2, "B" );
			GridMerge( iGrid, 3, 3, 2, 1 );			GridData( iGrid, 3, 3, "가이드 2");			GridData( iGrid, 3, 4, "F" );	GridData( iGrid, 4, 4, "B" );
			GridMerge( iGrid, 3, 5, 2, 1 );			GridData( iGrid, 3, 5, "가이드 1");			GridData( iGrid, 3, 6, "F" );	GridData( iGrid, 4, 6, "B" );
			GridMerge( iGrid, 5, 1, 2, 1 );			GridData( iGrid, 5, 1, "푸셔 3");			GridData( iGrid, 5, 2, "F" );	GridData( iGrid, 6, 2, "B" );
			GridMerge( iGrid, 5, 3, 2, 1 );			GridData( iGrid, 5, 3, "푸셔 2");			GridData( iGrid, 5, 4, "F" );	GridData( iGrid, 6, 4, "B" );
			GridMerge( iGrid, 5, 5, 2, 1 );			GridData( iGrid, 5, 5, "푸셔 1");			GridData( iGrid, 5, 6, "F" );	GridData( iGrid, 6, 6, "B" );
			GridMerge( iGrid, 7, 1, 2, 1 );			GridData( iGrid, 7, 1, "Align 3");			GridData( iGrid, 7, 2, "F" );	GridData( iGrid, 8, 2, "B" );
			GridMerge( iGrid, 7, 3, 2, 1 );			GridData( iGrid, 7, 3, "Align 2");			GridData( iGrid, 7, 4, "F" );	GridData( iGrid, 8, 4, "B" );
			GridMerge( iGrid, 7, 5, 2, 1 );			GridData( iGrid, 7, 5, "Align 1");			GridData( iGrid, 7, 6, "F" );	GridData( iGrid, 8, 6, "B" );
			GridMerge( iGrid, 9, 1, 2, 1 );			GridData( iGrid, 9, 1, "스토퍼 3");			GridData( iGrid, 9, 2, "UP" );	GridData( iGrid, 10, 2, "DN" );
			GridMerge( iGrid, 9, 3, 2, 1 );			GridData( iGrid, 9, 3, "스토퍼 2");			GridData( iGrid, 9, 4, "UP" );	GridData( iGrid, 10, 4, "DN" );
			GridMerge( iGrid, 9, 5, 2, 1 );			GridData( iGrid, 9, 5, "스토퍼 1");			GridData( iGrid, 9, 6, "UP" );	GridData( iGrid, 10, 6, "DN" );
			GridMerge( iGrid, 11, 1, 2, 1 );		GridData( iGrid, 11, 1, "클램프 3");		GridMerge( iGrid, 11,2,2,1 );	GridData( iGrid, 11, 2, "C" );
			GridMerge( iGrid, 11, 3, 2, 1 );		GridData( iGrid, 11, 3, "클램프 2");		GridMerge( iGrid, 11,4,2,1 );	GridData( iGrid, 11, 4, "C" );
			GridMerge( iGrid, 11, 5, 2, 1 );		GridData( iGrid, 11, 5, "클램프 1");		GridMerge( iGrid, 11,6,2,1 );	GridData( iGrid, 11, 6, "C" );
			GridMerge( iGrid, 13, 1, 1, 2 );		GridData( iGrid, 13, 1, "트레이 체크 3");
			GridMerge( iGrid, 13, 3, 1, 2 );		GridData( iGrid, 13, 3, "트레이 체크 2");
			GridMerge( iGrid, 13, 5, 1, 2 );		GridData( iGrid, 13, 5, "트레이 체크 1");
			GridMerge( iGrid, 14, 1, 1, 2 );		GridData( iGrid, 14, 1, "스톱 포지션 3");
			GridMerge( iGrid, 14, 3, 1, 2 );		GridData( iGrid, 14, 3, "스톱 포지션 2");
			GridMerge( iGrid, 14, 5, 1, 2 );		GridData( iGrid, 14, 5, "스톱 포지션 1");
		}
		else
		{
			...
			GridMerge( iGrid, 5, 3, 2, 1 );			GridData( iGrid, 5, 3, "푸셔 2");			GridData( iGrid, 5, 4, "F" );	GridData( iGrid, 6, 4, "B" );
			GridMerge( iGrid, 5, 5, 2, 1 );			GridData( iGrid, 5, 5, "푸셔 3");			GridData( iGrid, 5, 6, "F" );	GridData( iGrid, 6, 6, "B" );
			GridMerge( iGrid, 7, 1, 2, 1 );			GridData( iGrid, 7, 1, "Align 1");			GridData( iGrid, 7, 2, "F" );	GridData( iGrid, 8, 2, "B" );
			GridMerge( iGrid, 7, 3, 2, 1 );			GridData( iGrid, 7, 3, "Align 2");			GridData( iGrid, 7, 4, "F" );	GridData( iGrid, 8, 4, "B" );
			GridMerge( iGrid, 7, 5, 2, 1 );			GridData( iGrid, 7, 5, "Align 3");			GridData( iGrid, 7, 6, "F" );	GridData( iGrid, 8, 6, "B" );
		...
		GridMerge( iGrid, 17, 1, 2, 1 );		GridData( iGrid, 17, 1, "트랜스퍼 다운");		GridData( iGrid, 17, 2, "UP" );	GridData( iGrid, 18, 2, "DN" );
		...
		GridMerge( iGrid, 11, 7, 2, 1 );		GridData( iGrid, 11, 7, "픽커 1 다운" );	GridData( iGrid, 11, 8, "UP" ); GridData( iGrid, 12, 8, "DN" );
												GridData( iGrid, 13, 7, "픽커 4 흡입");										GridData( iGrid, 13, 8, "V" );
												GridData( iGrid, 14, 7, "픽커 3 흡입");										GridData( iGrid, 14, 8, "V" );
												GridData( iGrid, 15, 7, "픽커 2 흡입");										GridData( iGrid, 15, 8, "V" );
												GridData( iGrid, 16, 7, "픽커 1 흡입");										GridData( iGrid, 16, 8, "V" );
		GridMerge( iGrid, 17, 7, 1, 2 );		GridData( iGrid, 17, 7, "픽커 4 배출");
		GridMerge( iGrid, 18, 7, 1, 2 );		GridData( iGrid, 18, 7, "픽커 3 배출");
		GridMerge( iGrid, 19, 7, 1, 2 );		GridData( iGrid, 19, 7, "픽커 2 배출");
		GridMerge( iGrid, 20, 7, 1, 2 );		GridData( iGrid, 20, 7, "픽커 1 배출");
		...
		// COK STACKER
		GridMerge( iGrid, 18, 9, 2, 1 );			GridData( iGrid, 18, 9, "COK Stacker LOCK" );					GridData( iGrid, 18, 10, "L" );	GridData( iGrid, 19, 10, "UL" );
		GridMerge( iGrid, 20, 9, 1, 2 );			GridData( iGrid, 20, 9, "Stacker 포지션 체크" );

		// 컨베어
		GridMerge( iGrid, 18, 11, 1, 2 );			GridData( iGrid, 18, 11, "컨베어 1" );
		GridMerge( iGrid, 19, 11, 1, 2 );			GridData( iGrid, 19, 11, "컨베어 2" );
		GridMerge( iGrid, 20, 11, 1, 2 );			GridData( iGrid, 20, 11, "컨베어 3" );
	}
				...
				if(st_handler.mn_pogo_type == CTL_YES)
				{
					if(st_basic.n_mode_pogo == CTL_YES)
					{
						...
						if( nRet_1 == IO_ON || nRet_2 == IO_OFF)
						{
							...
							{
								sTempMSG = _T("TestSite1의 Clamp 또는 UnClamp 센서의 동작이 맞지 않습니다.");
				...
				if(st_handler.mn_pogo_type == CTL_YES)
				{
					if(st_basic.n_mode_pogo == CTL_YES)
					{
						...
						if( nRet_1 == IO_ON || nRet_2 == IO_OFF)
						{
							if (st_handler.cwnd_list != NULL)
							{
								sTempMSG = _T("TestSite2의 Clamp 또는 UnClamp 센서의 동작이 맞지 않습니다.");
...
void CScreen_Motor_With_IO::OnUpdateIO()
{
	...
	// Pogo 2012,1225 unclamp_chk가 off 면 출력 Clamp가 ON
	if(st_handler.mn_pogo_type == CTL_YES)
	{
...
void CScreen_Motor_With_IO::OnInitMotor()
{
	...
	else
	{
		...
		// BIN 3 Z
		GridData( iGrid, 8, 4, "BIN 3 Z 탑");		GridColor( iGrid, 8, 4, SKY_C, BLACK_C );
		GridData( iGrid, 9, 4, "BIN 3 Z 대기");		GridColor( iGrid, 9, 4, SKY_C, BLACK_C );
		GridData( iGrid, 10, 4, "BIN 3 Z 회전");		GridColor( iGrid, 10, 4, SKY_C, BLACK_C );
		GridData( iGrid, 11, 4, "BIN 3 Z 들기");		GridColor( iGrid, 11, 4, SKY_C, BLACK_C );
		GridData( iGrid, 12, 4, "BIN 3 Z 바닥");		GridColor( iGrid, 12, 4, SKY_C, BLACK_C );

		// BIN 3 R
		GridData( iGrid, 13, 4, "BIN 3 R 기본");		GridColor( iGrid, 13, 4, PINK_D, BLACK_C );
		GridData( iGrid, 14, 4, "BIN 3 R 회전");		GridColor( iGrid, 14, 4, PINK_D, BLACK_C );
		...
		GridData( iGrid, 2, 7, "SITE 1 PICK 시작");		GridColor( iGrid, 2, 7, SKY_C, BLACK_C );
		GridData( iGrid, 3, 7, "SITE 1 PICK 끝");		GridColor( iGrid, 3, 7, SKY_C, BLACK_C );
		GridData( iGrid, 4, 7, "SITE 2 PICK 시작");		GridColor( iGrid, 4, 7, SKY_C, BLACK_C );
		GridData( iGrid, 5, 7, "SITE 2 PICK 끝");		GridColor( iGrid, 5, 7, SKY_C, BLACK_C );
		GridData( iGrid, 6, 7, "TRAY 1 PICK");			GridColor( iGrid, 6, 7, SKY_C, BLACK_C );
		GridData( iGrid, 7, 7, "TRAY 2 PICK");			GridColor( iGrid, 7, 7, SKY_C, BLACK_C );
		GridData( iGrid, 8, 7, "REJ PICK");				GridColor( iGrid, 8, 7, SKY_C, BLACK_C );

		GridData( iGrid, 9, 7, "SITE 1 COK PICK 시작");		GridColor( iGrid, 9, 7, PINK_D, BLACK_C );
		GridData( iGrid, 10, 7, "COK 스태커 PICK 시작");	GridColor( iGrid, 10, 7, PINK_D, BLACK_C );
		GridData( iGrid, 11, 7, "COK 스태커 PICK 끝");		GridColor( iGrid, 11, 7, PINK_D, BLACK_C );

		GridData( iGrid, 12, 7, "SITE 1 PLACE 시작");		GridColor( iGrid, 12, 7, GREEN_L, BLACK_C );
		GridData( iGrid, 13, 7, "TRAY 1 PLACE 시작");		GridColor( iGrid, 13, 7, GREEN_L, BLACK_C );
		GridData( iGrid, 14, 7, "SITE 1 COK PLACE 시작");		GridColor( iGrid, 14, 7, GREEN_L, BLACK_C );
		GridData( iGrid, 15, 7, "COK 스태커 PLACE 시작");		GridColor( iGrid, 15, 7, GREEN_L, BLACK_C );
		...
		GridData( iGrid, 13, 10, "로봇X COK ST 시작");	GridColor( iGrid, 13, 10, SKY_C, BLACK_C );
		GridData( iGrid, 14, 10, "로봇X COK ST 끝");		GridColor( iGrid, 14, 10, SKY_C, BLACK_C );
		...
		GridData( iGrid, 13, 13, "로봇Y COK ST 시작");	GridColor( iGrid, 13, 13, SKY_C, BLACK_C );
		GridData( iGrid, 14, 13, "로봇Y COK ST 끝");		GridColor( iGrid, 14, 13, SKY_C, BLACK_C );

		
		// COK 
		GridData( iGrid, 1, 16, "COK ROBOT Y 시작");			GridColor( iGrid, 1, 16, GREEN_L, BLACK_C );
		GridData( iGrid, 2, 16, "COK ROBOT Y 끝");			GridColor( iGrid, 2, 16, GREEN_L, BLACK_C );
		
		GridData( iGrid, 4, 16, "COK ROBOT Z SAFETY");			GridColor( iGrid, 4, 16, GREEN_L, BLACK_C );
		GridData( iGrid, 5, 16, "COK ROBOT Z 1개");			GridColor( iGrid, 5, 16, GREEN_L, BLACK_C );
		GridData( iGrid, 6, 16, "COK ROBOT Z 20개");			GridColor( iGrid, 6, 16, GREEN_L, BLACK_C );

		// REJECT TRAY STACKER
		GridData( iGrid, 8, 16, "REJ 1장");				GridColor( iGrid, 8, 16, PINK_D, BLACK_C );
		GridData( iGrid, 9, 16, "REJ 5장");				GridColor( iGrid, 9, 16, PINK_D, BLACK_C );

		// TR Y
		GridData( iGrid, 11, 16, "TR Y 리젝트");		GridColor( iGrid, 11, 16, YELLOW_L, BLACK_C );
		GridData( iGrid, 12, 16, "TR Y BIN 3");			GridColor( iGrid, 12, 16, YELLOW_L, BLACK_C );
		
		// TR CLAMP
		GridData( iGrid, 14, 16, "TR 클램프 열기");		GridColor( iGrid, 14,16, YELLOW_L, BLACK_C );
		GridData( iGrid, 15, 16, "TR 클램프 잡기");		GridColor( iGrid, 15, 16, YELLOW_L, BLACK_C );
	}
}
...
void CScreen_Motor_With_IO::OnBtnDown() 
{
		...
		( abs(dChk_Y - g_comiMgr.Get_MotCurrentPos( MOTOR_ROBOT_Y )) > 0.1f ) )
	{
		...
		{
			if (DoModal_Msg( "X, Y축 위치가 맞지 않습니다." ) == IDOK)
				return ;
		}
	}
...
{
	// TODO: Add your control notification handler code here
	m_strTempMSG = "테스트 사이트 1 의 시작위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "테스트 사이트 1 의 시작위치 저장완료. (XYZ)";
...
{
	m_strTempMSG = "테스트 사이트 1 의 끝위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "테스트 사이트 1 의 끝위치 저장완료";
...
{
	m_strTempMSG = "테스트 사이트 2 의 시작위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "테스트 사이트 2 의 시작위치 저장완료. (XYZ)";
...
{
	m_strTempMSG = "테스트 사이트 2 의 끝위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "테스트 사이트 2 의 끝위치 저장완료";
...
{
	m_strTempMSG = "트레이 1 의 시작위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 1 의 시작위치 저장완료. (XY)";
...
{
	// TODO: Add your control notification handler code here
	m_strTempMSG = "트레이 1 의 끝위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 1 의 끝위치 저장완료. (XY)";
...
{
	m_strTempMSG = "트레이 2 의 시작위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 2 의 시작위치 저장완료. (XY)";
...
{
	m_strTempMSG = "트레이 2 의 끝위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 2 의 끝위치 저장완료. (XY)";
...
{
	m_strTempMSG = "트레이 3 의 시작위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 3 의 시작위치 저장완료. (XY)";
...
{
	m_strTempMSG = "트레이 3 의 끝위치 저장합니다. (XY)";
	...
	m_strTempMSG = "트레이 3 의 끝위치 저장완료. (XY)";
	if ( g_local.GetLocalType() == LOCAL_ENG ) m_strTempMSG = _T("Tray3 End Pos save complete.(XY)");
	DoModal_Msg( m_strTempMSG);
...
{
	m_strTempMSG = "리젝트 트레이의 시작위치 저장합니다. (XYZ 플레이스 위치)";
	...
	m_strTempMSG = "리젝트 트레이의 시작위치 저장완료. (XYZ)";
...
{
	m_strTempMSG = "리젝트 트레이의 끝위치 저장합니다. (XY)";
	...
	m_strTempMSG = "리젝트 트레이의 끝위치 저장완료. (XY)";
...
{
	m_strTempMSG = "COK STACKER의 시작위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "COK STACKER의 시작위치 저장완료. (XYZ)";
...
{
	m_strTempMSG = "COK STACKER의 끝위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "COK STACKER의 끝위치 저장완료. (XYZ)";
...
{
	m_strTempMSG = "테스트 사이트 1 COK의 시작위치 저장합니다. (XYZ)";
	...
	m_strTempMSG = "테스트 사이트 1 COK의 시작위치 저장완료. (XYZ)";
...
{
	// TODO: Add your control notification handler code here
	m_strTempMSG = "테스트 사이트 1 PLACE의 시작위치 저장합니다. (Z)";
	...
	m_strTempMSG = "테스트 사이트 1 PLACE의 시작위치 저장완료. (Z)";
...
{
	m_strTempMSG = "트레이1의 PLACE 시작위치 저장합니다. (Z)";
	...
	m_strTempMSG = "트레이1의 PLACE 시작위치 저장완료. (Z)";
...
{
	m_strTempMSG = "테스트사이트 1 COK PLACE 시작위치 저장합니다. (Z)";
	...
	m_strTempMSG = "테스트사이트 1 COK PLACE 시작위치 저장완료. (Z)";
...
{
	m_strTempMSG = "COK STACKER PLACE 시작위치 저장합니다. (Z)";
	...
	m_strTempMSG = "COK STACKER PLACE 시작위치 저장완료. (Z)";
...
{
	m_strTempMSG = "SITE 1 의 2,3,4 위치를 계산, 저장합니다. (X,Y)";
	...
	m_strTempMSG = "SITE 1 의 2,3,4 위치를 계산, 저장완료. (X,Y)";
...
{
	m_strTempMSG = "SITE 2 의 2,3,4 위치를 계산, 저장합니다. (X,Y)";
	...
	m_strTempMSG = "SITE 2 의 2,3,4 위치를 계산, 저장완료. (X,Y)";
