...
public:
	...
	double md_spd_jog[BD_MAX_MOTOR];			//Jog 속도 설정 
...
public:
	...
	int Check_MotPosRange(int n_Axis, double d_Distance, double d_Range);
...
//	int Start_SingleMove(int n_Axis, double d_Distance, double *dp_SpeedVel); //double *dp_SpeedRatio);
	...
	double XYDistance(double xStart, double yStart, double xEnd, double yEnd);//2016.0330
