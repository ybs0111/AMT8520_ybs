...
CAlg_Mysql::CAlg_Mysql()
{
	...
	//2016.0428
	mn_dbtime_hifix_cnt		= 5;
	
	mstr_dbtime_hifix_name[0] 	= "Hifix";
	mstr_dbtime_hifix_name[1]	= "Slot";
	
	mstr_dbtime_hifix_name[2]	= "Serial";
	mstr_dbtime_hifix_name[3]	= "Count";
	mstr_dbtime_hifix_name[4]	= "Model_Name";	
	
	mn_dbtime_hifix_type[0]  = ID_TYPE;
	mn_dbtime_hifix_type[1]  = INT_TYPE;
	mn_dbtime_hifix_type[2]  = TEXT_TYPE;
	mn_dbtime_hifix_type[3]  = INT_TYPE;
	mn_dbtime_hifix_type[4]  = TEXT_TYPE;
	
	mn_dbtime_hifix_num[0]		= 6;
	mn_dbtime_hifix_num[1]		= 6;
	mn_dbtime_hifix_num[2]		= 50;
	mn_dbtime_hifix_num[3]		= 6;
	mn_dbtime_hifix_num[3]		= 6;
	////
}
